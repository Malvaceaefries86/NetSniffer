...
4. If Windows shows a security prompt, choose Run or More info, then Run anyway if you trust the source.
5. Follow any on-screen steps.
6. Open NetSniffer from the Start menu or desktop shortcut.

## 🖱️ How to Use NetSniffer

After you open the app, you should see a live list of network activity.

Typical steps:
1. Start the app with normal user rights.
2. Let it scan your active network sockets.
3. Review the list of TCP and UDP connections.
4. Look at the process name next to each entry.
5. Check the risk label for each connection.
6. Sort by process, port, or remote address if needed.
...
### Some processes look unfamiliar
...
## ⚙️ Running on Windows Security Settings
